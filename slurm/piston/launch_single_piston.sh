...
#SBATCH --output=/home/a00861921/Projects/open-r1/logs/piston/worker-logs/%x-%j.out
#SBATCH --error=/home/a00861921/Projects/open-r1/logs/piston/worker-logs/%x-%j.out  # Redirect error logs to .out
...
srun --container-mounts=/home/a00861921/Projects/ioi2024/piston_files/packages:/piston/packages --container-image "ghcr.io#engineer-man/piston:sha256:63b5654156a89c5a2ad281aface21416615d62ec056d88efe8fcd307ce73575a" \
    bash -c "
