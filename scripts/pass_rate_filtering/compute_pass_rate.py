...
def main(script_args, training_args, model_args):
    ...
    def batch_score(examples):
        ...
        for i, reward_func in enumerate(reward_funcs):
            ...
            reward_kwargs = {
                key: repeat_each_element_k_times(examples[key], training_args.num_generations) for key in keys
            }
    ...
    if script_args.dataset_start_index is not None and script_args.dataset_end_index is not None:
        ...
        filtered_config_name = (
            f'{filtered_config_name}-{script_args.dataset_start_index}-{script_args.dataset_end_index}'
        )
    ...
    logger.info(
        f'Filtering dataset with low reward threshold {script_args.pass_rate_min} and high reward threshold {script_args.pass_rate_max}'
    )
